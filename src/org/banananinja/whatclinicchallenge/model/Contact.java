...
public class Contact {
    ...
    //Constructors
	public Contact(String name, String phone, String country, String email) {
		super();
		this.name = name;
		this.phone = phone;
	...
	public static void packageAsIntent(Intent intent, String name, String phone, String country, String email){
	...
	public String toString() {
		return "Contact [name=" + name + ", phone=" + phone + ", country="
				+ country + ", email=" + email + "]";
	}
